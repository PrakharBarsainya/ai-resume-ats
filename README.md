...
2. ⚙️ The backend parses the resume, extracts skills and experience, and compares them to the JD using semantic similarity.
...
4. 💾 Past analyses are saved to your account so you can revisit them. You can also download the report after analysing in .pdf format.
...
- ⚠️ **Never commit `.env` or `secrets.toml`** — they hold API keys. Both are in `.gitignore`; check before you push.
